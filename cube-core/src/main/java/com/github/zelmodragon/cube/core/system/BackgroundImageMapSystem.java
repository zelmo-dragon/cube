 ...
 */
public class BackgroundImageMapSystem extends AbstractSystem {

    /**
     * Indice de profondeur de l'arrière-plan.
     */
     ...
     */
    BackgroundImageMapSystem(final GameManager manager, final int priority) {
